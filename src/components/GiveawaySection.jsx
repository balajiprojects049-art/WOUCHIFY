  ...
  return (
    <section className="mt-20 grid gap-5 md:grid-cols-2">
      <article className="rounded-2xl bg-midnight p-7 text-white shadow-sm transition-all duration-300 hover:-translate-y-2 sm:p-8">
        ...
        <p className="mt-3 max-w-sm text-sm text-slate-200">Enter this week’s draw for smart devices and accessories worth over $500.</p>
        <button className="mt-5 rounded-xl bg-white px-4 py-2 text-sm font-semibold text-ink transition-all duration-300 hover:scale-105">
          Enter Now
        </button>
      </article>
