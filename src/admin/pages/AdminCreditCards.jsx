...
const EMPTY = { bank: '', card: '', cashback: '', partners: '', rewards: '', type: 'shopping', cardImage: '', active: true }
        ...
        <div className="space-y-5 sticky top-4 self-start">
          ...
          <div className="rounded-2xl p-5" style={cardStyle}>
            ...
            <div className="relative overflow-hidden rounded-2xl p-5" style={{
              ...
              <div className="inline-flex flex-col rounded-xl px-2.5 py-1.5 text-xs font-bold mb-3" style={{ background: 'rgba(255,255,255,0.9)', color: '#0D1117' }}>
